...
- Starea produselor (instalat / actualizare / eroare / incompatibil) calculată în nucleu și folosită de carduri; după o instalare eșuată, butonul devine „Reîncearcă”.
...
- Actualizarea automata verifica suma de control a arhivei si semnatura GDC a instalatorului inainte sa-l ruleze; refuza arhivele cu mai multe instalatoare.
- Linkul de descarcare Windows din `update.json` e versionat (nu mai depinde de ultimul release publicat).
...
### Changed
- **Sectiunile din meniul lateral se pliaza**, cu o sageata care se roteste lin.
  La prima pornire e deschisa doar „Instalare DaVinci Resolve"; aplicatia tine
  minte apoi ce ai lasat deschis. O rubrica selectata dintr-o sectiune inchisa
  o deschide singura.
