...
#
# Certificatul e COMUN pentru toate aplicatiile GDC (decizie explicita
# Cristi) - secretele CI se numesc IDENTIC in toate repo-urile
# (WIN_SELFSIGN_PFX_BASE64/WIN_SELFSIGN_PFX_PASSWORD), incarcate separat,
# o data per repo, de Cristi.
#
...
try {
    ...
    # [FIX 2026-09-06, mostenit din CGConvertor] Esec real de CI:
    # "signtool verify /pa" valideaza LANTUL COMPLET de incredere (pana
    # la un certificat radacina de incredere pe MASINA care verifica) -
    # pe runner-ul CI (o masina Windows noua, temporara), certificatul
    # nostru self-signed NU e importat in Trusted Root (normal - doar
    # Cristi si colaboratorii au facut asta local, vezi
    # README-windows.md), deci verificarea de incredere esueaza mereu
    # aici, chiar daca semnarea a reusit perfect. Fix: verificam DOAR ca
    # fisierul are efectiv o semnatura Authenticode atasata
